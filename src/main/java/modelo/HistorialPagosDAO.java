...
public class HistorialPagosDAO {
    ...
    String sql = "SELECT " +
        // 1. Identificador único del pago/pedido
        "p.Pedido_id AS idPago, " +
        
        // 2. El "Truco Maestro": Revisa el nombre en el Camino A; si es NULL, 
        // toma el del Camino B. Si ambos son NULL, deja 'Cliente Temporal'.
        ...
        // 3. Datos financieros y de control del pedido
        ...
        // ==========================================================================
        // 🛒 CAMINO A: RASTREO PARA COMPRAS DE CATÁLOGO
        // ==========================================================================
        ...
        // ==========================================================================
        // 📐 CAMINO B: RASTREO PARA PEDIDOS DESDE CERO (A MEDIDA)
        // ==========================================================================
        ...
        // ==========================================================================
        // CHASSI DE CIERRE Y ORDENAMIENTO
        // ==========================================================================
